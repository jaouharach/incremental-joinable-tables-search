...
%	relative food prices affect dietary quality
	...
	\textbf{Attempt 3:} As a last attempt the user gave up on getting any fast meaningful result so he/she decide to increase $k$ significantly in hope that a relevant table will appear in the list of results. He/she submits $Q_{3} =$ (Table \ref{tab:q1-result1}, Join column : "Food", $k = 200$). Finally and after several attempts, the search engine returned Table \ref{tab:q1-result2} at position $11$ which contains information on food prices from the 2007 WIC program. % k = 100 \\
